 ...
 */
@IntegrationTest
public class DefaultExtension1ServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "extension1PlatformLogo";

		// when
		final String logoUrl = extension1Service.getHybrisLogoUrl(logoCode);
