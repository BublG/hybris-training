...
public class DefaultExtension1Service implements Extension1Service
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultExtension1Service.class);
	...
	{
		return DefaultExtension1Service.class.getResourceAsStream("/extension1/sap-hybris-platform.png");
	}
